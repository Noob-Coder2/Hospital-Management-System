...
//import cg.hospital.HospitalApplication;
//
...
//    // Verify Smith exists — appointment data verified via endpoint test
...
//    // Smith's PCP (physician) is verified via patient join
//    Optional<Patient> smith = patientRepository.findById(SSN_SMITH);
//    assertThat(smith).isPresent();
...
//    // Verified via endpoint test — AppointmentRepository excluded from this context
//    // Patient Smith (SSN_SMITH) exists and has appointments in seed data
//    Optional<Patient> smith = patientRepository.findById(SSN_SMITH);
//    assertThat(smith).isPresent();
//}
//
